...
router.get('/config-tiempos', requireAuth, OperacionController.configTimersView as any);
router.get('/config-tiempos/data', requireAuth, OperacionController.configTimersData as any);
router.post('/config-tiempos/save', requireAuth, OperacionController.configTimersSave as any);
router.post('/config-tiempos/:id/toggle', requireAuth, OperacionController.configTimersToggle as any);
